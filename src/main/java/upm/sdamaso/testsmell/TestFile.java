...
public class TestFile {
    ...
    /**
     * Returns the path of the test file relative to the folder with the name of the
     * project.
    ...
    /**
     * Returns the path of the production file relative to the folder with the name
     * of the project.
     * If the project directory has a different name, returns an empty string.
     * 
