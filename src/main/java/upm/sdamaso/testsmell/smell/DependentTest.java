    ...
    public void runAnalysis(CompilationUnit testFileCompilationUnit, CompilationUnit productionFileCompilationUnit,
        ...
        for (TestMethod testMethod : testMethods) {
            if (testMethod.getCalledMethods().stream().anyMatch(x -> x.getName()
                ...
                smellyElementList
                        .add(new upm.sdamaso.testsmell.TestMethod(testMethod.getMethodDeclaration().getNameAsString()));
            }
        }
         ...
         * for (TestMethod testMethod : testMethods) {
         * if (testMethods.get(i).getCalledMethods().stream().anyMatch(x ->
         * x.getName().equals(testMethod.getMethodDeclaration().getNameAsString()))) {
         * smellyElementList.add(new
         * testsmell.TestMethod(testMethod.getMethodDeclaration().getNameAsString()));
         * }
         * }
         * }
         */
